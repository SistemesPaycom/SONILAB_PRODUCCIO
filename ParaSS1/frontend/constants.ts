...
export const LOCAL_STORAGE_KEYS = {
  ...
  /** Mode de vista de la pestanya Media: 'list' | 'grid'. Frontend-only. */
  MEDIA_VIEW_MODE: 'snlbpro_media_view_mode',
  /** Agrupació visual de Media: 'none' | 'type' | 'format' | 'date'. */
  MEDIA_GROUP_BY: 'snlbpro_media_group_by',
  /** Filtre de tipus de Media: 'all' | 'video' | 'audio'. */
  MEDIA_TYPE_FILTER: 'snlbpro_media_type_filter',
  /** Criteri d'ordre de Media (independent de Files/Projectes). */
  MEDIA_SORT_BY: 'snlbpro_media_sort_by',
  /** Direcció d'ordre de Media. */
  MEDIA_SORT_ORDER: 'snlbpro_media_sort_order',
};
