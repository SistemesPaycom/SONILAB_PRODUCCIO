...
const selectedItem =
 ...
 const activeTasksCount =
  ...
  >
    ...
    className="px-2.5 py-2 rounded-lg font-semibold" style={{ backgroundColor: 'var(--th-btn-primary-bg)', color: 'var(--th-btn-primary-text)', fontFamily: 'var(--us-home-navtabs-family)', fontSize: 'var(--us-home-navtabs-size)', fontWeight: 'var(--us-home-navtabs-weight)' as any, fontStyle: 'var(--us-home-navtabs-style)' }}
